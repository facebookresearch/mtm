...
data_mean = np.array(
    [
        ...
        [73.74, 35.1, 88.7, 92.03, 21.2],
        [49.7, 19.4, 89.1, 113.5, 19.8],
        [87.7, 59.6, 96.4, 113.5, 27.2],
    ]
)
...
data_std = np.array(
    [
        ...
        [14.4, 16.35, 9.94, 1.34, 2.3],
        [3.37, 15.71, 8.9, 1.34, 5.5],
    ]
)
...
# for d4rl envs
# https://fairwandb.org/mtm_team/d4rl_paper_3_2?workspace=user-philippwu
env_names = [
    "D4RL\nHopper",
    "D4RL\nHalfCheetah",
    "D4RL\nWalker2D",
