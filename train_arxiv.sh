...
########
# MTM
python research/mtm/train.py -m +exp_mtm=adroit_cont wandb.project="mtm_adroit_2_24" args.seed=0,1,2,3,4,5 dataset.env_name=relocate,pen,hammer,door dataset.d_name="expert","medium_replay" "args.mask_patterns=[AUTO_MASK],[ID],[FD],[BC],[RCBC]" args.log_every=100
